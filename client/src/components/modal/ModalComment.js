...
import { X, Heart, Pencil, AtSign, Smile, ArrowUp, Trash2, SendHorizonal } from "lucide-react-native";
...
const CommentsModal = ({ visible, onClose, video_id }) => {
            ...
            <View className="flex-1 ml-3">
                ...
                <View className="flex-row items-center mt-2 justify-between">
                    <View className="flex-row items-center">
                        ...
                        <Text className="mx-2 text-gray-400">Reply</Text>
                    </View>
                    ...
                    <View className="flex-row items-center gap-4">
                        ...
                        {isEdit && item._id === currentCommentId ? (
                            <TouchableOpacity onPress={() => onDisableEditStatus(item._id, item.content)}>
                                <View className="flex-row justify-center items-center">
                                    <SendHorizonal size={16} color="#9CA3AF" />
                                </View>
                            </TouchableOpacity>
                        ) : (
